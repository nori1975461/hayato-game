...
const SPRITES = {
  ...
  // じゃりゅうバハムート: 最終ボス。黒い体＋金の角＋赤い目＋炎の口＋紫の翼
  dragon: [
    '....YY..................YY......',
    '.....YY....KKKKKK......YY.......',
    '......YY..KKKKKKKK....YY........',
    ...
    '.......KKWKWKWKWKK..............',
    '..pp....KKKKKKKKKK....pp........',
    '.pppp...KKKKKKKKKKK..pppp.......',
    'pppppp..KKKKKKKKKKKKpppppp......',
    'ppppppp.KKKPPPPPPKKKppppppp.....',
    'pppppppKKKPPPPPPPPKKKppppppp....',
    'ppppppKKKPPPPPPPPPPKKKpppppp....',
    'pppppKKKKPPPPPPPPPPKKKKppppp....',
    '.ppp.KKKKKPPPPPPPPKKKKK.ppp.....',
    '.....KKKKKKPPPPPPKKKKKK.........',
    '.....KKKKKKKKKKKKKKKKKK.........',
    '....KKKKK..KKKK..KKKKKK.........',
    '....KKKK....KK....KKKKKK........',
...
const BOSS_TYPES = [
  ...
  { name: 'ジャイアントスパイダー', origin: 'きょだいまじゅう', sprite: 'spider', aura: '#8b4f8b', pattern: 'cross', shot: 'web',
    gimmicks: ['summon'],            melee: ['punch'], hpMul: 1.05, ballColors: ['#f4f4f4', '#94b0c2', '#f4f4f4'],
    serifu: 'いとに かかった えものは にがさぬ…' },
  ...
  { name: 'ワイバーン',     origin: 'じゃりゅうのそっきん', sprite: 'dragon', aura: '#41a6f6', pattern: 'mix', shot: 'ball',
    gimmicks: ['speed', 'rage'],     melee: ['dive', 'punch', 'tail'], hpMul: 1.5,
    remap: { K: '#29366f', P: '#3b5dc9', p: '#41a6f6', O: '#73eff7', R: '#73eff7' }, ballColors: ['#41a6f6', '#73eff7', '#f4f4f4'],
    serifu: 'バハムートさまのもとへは いかせん！' },
  { name: 'デスサイザー',   origin: 'じゃりゅうのそっきん', sprite: 'chronos', aura: '#8b4f8b', pattern: 'spiral', shot: 'scythe',
    gimmicks: ['teleport', 'summon'], melee: ['tail', 'stomp'], hpMul: 1.65, mods: { dart: true }, ballColors: ['#94b0c2', '#73eff7', '#94b0c2'],
    serifu: 'ここから さきは しのせかい…' },
  { name: 'じゃりゅうバハムート', origin: 'さいきょうのじゃりゅう', sprite: 'dragon', aura: '#b13e53', pattern: 'mix', shot: 'ball',
...
let serifuTimer = 0, serifuName = '', serifuText = ''; // ボス出現セリフ（ドラクエ風ウィンドウ）
