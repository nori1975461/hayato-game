...
if (Array.isArray(PLAYER_SPRITES)) {
  ...
  // R15c: 被覆が肩から下へ拡大し、Stage3の肩当ては首の横（5行目）まで立ち上がるので、
  // 不変範囲の「頭」は 0-4行 に精密化（5行目の中央＝胴の芯としてチェック継続）。
  // 少年の芯はキャンバス中央の16列に常に置き、①頭（0-4行）②脚と裾（13-17行）
  // ③胴の芯（5-12行の中央16列のうち5〜10列）が Stage1 と完全一致すること。
