...
// 既定 GAIKA2＝候補 63（ふだん＝左肩は跳ね上げ・金）／GAIKA2_KEYDOWN＝候補 87（鍵が入った姿）／GAIKA2_FINAL＝候補 80（最終形態）
...
let ng = 0;
for (const [name, built, no] of [['GAIKA2', GAIKA2, 63], ['GAIKA2_KEYDOWN', GAIKA2_KEYDOWN, 87], ['GAIKA2_FINAL', GAIKA2_FINAL, 80]]) {
  const c = CANDS[no];
