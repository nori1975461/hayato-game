...
//      実測＝塗り 521×701 px（124×167 units）＝**棒込み 0.743・本体のみ 0.849**。縦を伸ばした内訳は四つ：環 142×60→122×68（狭く高く・rig oy −10）／光背の骸を上へ振る／台座 34→58 で**須弥壇（上框・朱の一筋・連子窓の三面・下框）**を足す／冕冠 CROWN_H 26→34（角と中心の鉾を伸ばす・rig oy −48）／錫杖を基壇の床まで伸ばして**杖が床に立つ**（ARML_H 160→186）。
