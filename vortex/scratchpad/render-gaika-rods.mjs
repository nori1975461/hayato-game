...
const capz = keys.map((k) => crop(GAIKA_RODS[k], -66, -92, 26, 34, 3));           // 上端の箍を 3 倍
...
text(cv, 'SOUSHIN GAIKA / 22ND PLAN - ONYX SHAFT + 4 IDEAS FOR THE HEAD / IN GAME SCALE 4.2', gap, 10, WHITE, 2);
