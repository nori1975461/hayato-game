#!/bin/bash
# 蒼神骸華 第二案：いまの作業の土台（resume-gaika-now.mjs の候補 19）に、札ごとの追加分を足して、同じ場所・同じ倍率で格子に並べて撮る。
...
#   目安: 頭 4倍 (0,-54) 枠156×176／顔の両脇 4倍 (0,-42) 枠208×150／肩当て（両肩）3倍 (0,-40) 枠312×132／等倍の全身 1倍 (0,13.5) 枠344×352
BASE='"kit":"launcher","foreTurn":[20,35],"subStraight":true,"stowed":true,"thirdArm":false,"subBehind":true,"dormantX":"sliverEmber","subBoom":true,"subBlade":"eclipse","shoulder":{"edge":"none","bands":false,"flare":5,"topW":9,"scale":0.88,"dx":7,"accent":"chamfer"},"collar":{},"head":{"cheek":"steel","top":"sunk"}'
