...
export const BALANCE = {
  ...
  archetypes: {
    ...
    // ★R50 trueFormNoMobit: ビリッコ（AMMO）が居ないランへの保証発数。実プレイFB
    //   「軌道神核戦だけで特殊弾をふたつ」。手持ちのモビット次第で切り札0発のまま
    //   本編最長・最強の戦闘に入っていた。ビリッコ持ちは従来どおり（trueFormRefill=3）で、
    //   こちらは**居ないときだけ**働く下限＝重ね取りは起きない。
    AMMO: { firstDelaySec: 4, refillSec: 16, perBoss: 1, perFinal: 2,
            trueFormRefill: 3, trueFormDelaySec: 5, trueFormNoMobit: 2 },
