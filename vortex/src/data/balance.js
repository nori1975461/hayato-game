    ...
    tiers: [
      ...
      //    radius/glow/spawnDist も追随縮小（通常ボスの radius 64〜76 帯へ）。
      {
        ...
        trueForm: {
          ...
          //   本番実測の中央値299/秒 × 目標100秒 ≒ 30000。実装後の実測は **74.7／109.4／165.6秒**
          //   （中央値109秒）で、うち2つは撃破まで到達。真の姿は第1形態（22000）より
          //   HPは小さいが、眼が殻で隠れる・座へ転移して遠い・激化で避ける手が増えるぶん
          //   **実時間では第1形態より長い**（実測でも第1形態の2倍前後）。
          //   ⚠️ 尺の根拠に練習場のDPSを二度と使わないこと。test-core の式も実測値へ直した。
          hp: 30000, radius: 92, spriteScale: 7.4, glowScale: 10.6,
          ...
          //   30000×0.15＝**4500**＝装甲片1枚＋投げ1発、または投げ3発。窓1.4秒に届く側へ置く。
