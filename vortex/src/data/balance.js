    ...
    tiers: [
      ...
      //    radius/glow/spawnDist も追随縮小（通常ボスの radius 64〜76 帯へ）。
      {
        ...
        trueForm: {
          ...
          text2: 'しん・マオウレクス「きどうしんかく」',
          name: 'しん・マオウレクス',    // HPバーの見出し（第4形態は名前も変わる）
          // --- 本体 ---
          ...
          //     ②`sweepDeg 14 → 120`（片方向）＝**横へ一歩ずれる答えを消す**。薙ぎは104°/s、
          ...
          aligned: { alignSec: 2.0, lockSec: 0.55, beamWidth: 100, beamLength: 760, damage: 84,
                     sweepDeg: 120, sweepOneWay: true, windUpDeg: 18, showLine: false,
                     scorch: true, activeSec: 1.15,
