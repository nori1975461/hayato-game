      ...
      //    radius/glow/spawnDist も追随縮小（通常ボスの radius 64〜76 帯へ）。
      {
        ...
        trueForm: {
          ...
          rage: {
            ...
            wavesAdd:    [0, 0, 1, 1],              // 殻の衝撃波 3→4波（網目が1枚増える）
          ...
          shell: { teleSec: 0.7, closeSec: 1.4, holdSec: 1.4, openSec: 0.6, breakSec: 1.8,
                   interruptRatio: 0.041,
                   waves: 3, waveInterval: 0.22, perWave: 18, bulletSpeed: 300,
                   bulletRadius: 7, damage: 20, lifeSec: 2.0 },
        },
