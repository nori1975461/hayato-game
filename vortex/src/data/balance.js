    ...
    tiers: [
      ...
      //    radius/glow/spawnDist も追随縮小（通常ボスの radius 64〜76 帯へ）。
      {
        ...
        trueForm: {
          ...
          // ★R43 lockSec 0.85＝環が揃いきる前に**射線が確定して見える**時間。148×0.85=126px ＞
          //   判定半幅57px。旧実装は発射フレームで既にビーム内（座230px×sin7°=28px ＜ 57px）＝
          //   反応時間0の確定84ダメージだった。整列の薙ぎは中心のまま（±7°）＝「形で読める」
          //   という長所を壊さない。ロックだけで避けられるようになる。
          aligned: { alignSec: 2.0, lockSec: 0.85, beamWidth: 100, beamLength: 760, damage: 84,
                     sweepDeg: 14, activeSec: 0.9,
