...
// ★R36W2 再合体後（第3形態）の実パレット。実プレイFB「メタリックパープルに変えて。いまは
//   一部のみ変わっただけに見える。赤部分をメタリックパープルに変えて」。
// ⚠️ tint（乗算）では赤は紫にならない：#e5202c に紫 #a86bff を掛けても #970d2c＝**赤のまま**
//   （赤にはB成分がほぼ無いので、何を掛けてもBは増えない）。灰色の装甲だけ紫がかり、赤い主面が
//   赤のまま残る＝「一部のみ変わった」の正体。色を変えるにはテクスチャそのものを焼き直すしかない。
// 置き換えの方針：赤ファミリー(m/r/d/S)→紫ファミリー、暗部(g/M/p/j/f/k/F)→紫がかった暗部、
//   シルバー縁(s)→ラベンダー白。金冠(y)とシアン炉心(c)はアクセントとして残す（全部を紫にすると
//   「紫くなった」ではなく「暗くなった」に見える。R34の教訓）。
// ⚠️ キー集合は MAOU_PAL と完全一致させること。1色でも欠けると makeSprite が未定義色を透明として
//   飛ばし、**装甲に穴が開く**（test-core が集合一致を検証している）。
const MAOU_PAL_P = { k: '#0b0810', j: '#130c1c', f: '#1e1229', g: '#382153', m: '#8b3fd6', s: '#e6d4f8', c: '#38e1ff', r: '#c470ff', d: '#5c2a94', y: '#c8860f', S: '#8b3fd6', M: '#382153', F: '#201a38', p: '#281838' };
// 真マオウレクス「軌道神核」＝メタリックパープルの体を砕いて現れる第4形態。
// 装甲に覆われた球（神核）の窓から血走った単眼が覗き、傾きの違う3つの環が球を貫いて公転する。
// 設計と作り直しの経緯は vortex/scratchpad/maou-true-candidates.mjs（ラスタライザ付き）。
//   ・球の明暗は法線×光源のシェーディング＋市松ディザ（手置きは必ず同心円の縞になる）
//   ・質感の主役は階調ではなく「大きな面＋黒い溝＋面の中の明度差」＝マオウレクス本体と同じ作法
//   ・環は前半分(f)と後半分(b)に割ってあり、球の手前と奥に振り分ける＝土星の環と同じ描き方
//   ・奥半分(b)は装飾を持たず一段暗い。全部を同じ密度で描くと交差した瞬間に画面が団子になる
const MAOU_T_PAL = { k: '#04040c', j: '#141426', m: '#262640', f: '#454570', n: '#cdcdf0', c: '#ffffff', C: '#cfe0ff', a: '#ff2f6a', y: '#ffd23f', Y: '#c9971f', W: '#ffedb0', r: '#8a1622', R: '#e03040', O: '#ff8a2a', q: '#2a1e52', Q: '#4a3b7d', P: '#7c66c9', N: '#c0aef5', e: '#1a2b4d', E: '#2f4f85', D: '#4d7ccc', M: '#a6c6f7', i: '#163f36', I: '#276b5c', H: '#3aa98a', L: '#96e9cd' };
const MAOU_TRUE_SPRITES = {
  ringAb: { palette: MAOU_T_PAL, rows: [
    '...................................................',
    '...................................................',
    '...................................................',
    '.....kkkkkkkkkkkkk.................................',
    '...kkkqqQQQQQQqqkkkkkk.............................',
    '..kkqQQQPPPPPPPQQQQqqkkkk..........................',
    '.kkqQPPQQQQQQQQQQQPPQQQqkkkk.......................',
    '..qQPPQQqqqqqqqqqqQQQQPQQqqkkk.....................',
    '....PQQqqk......kkqqqqQQQPQQqkkk...................',
    '......qq.............kqqqQQPQQqkkk.................',
    '........................kqqQQPPQqkkk...............',
    '..........................kqqQQPPQqkkk.............',
    '.............................qqQQPQQqkk............',
  ...
  ringAf: { palette: MAOU_T_PAL, rows: [
    '...................................................',
    '...................................................',
    '...................................................',
    '...................................................',
  ...
  ringBb: { palette: MAOU_T_PAL, rows: [
    '...................................................',
    '...................................................',
    '...................................................',
    '.................................kkkkkkkkkkkkk.....',
    '.............................kkkkkkeeEEEEEEeekkk...',
    '..........................kkkkeeEEEEDDDDDDDEEEekk..',
    '.......................kkkkeEEEDDEEEEEEEEEEEDDEekk.',
    '.....................kkkeeEEDEEEEeeeeeeeeeeEEDDEe..',
    '.....................keEEDEEEeeeekk......keeEED....',
    '.....................EEDEEeeek.............ee......',
    '......................EEeek........................',
    '......................eek..........................',
    '...................................................',
  ...
  ringBf: { palette: MAOU_T_PAL, rows: [
    '...................................................',
    '...................................................',
    '...................................................',
    '...................................................',
    ...
    '........................keeEMkMDEkkk...............',
    '......ee.............keeEEMMDkkkkk.................',
    '....Mkkkek......kkeeeEEMMcDDEkkk...................',
    '..EkkkEEEeeeeeekeEEEMMMDDEEkkk.....................',
    '.kkkDMMMMEEEEEkEMMMMDyDEkkkk.......................',
    '..kkEDDyMMMMckkDDDDEEkkkk..........................',
    '...kkkEEDDDDDkEEkkkkkk.............................',
    '.....kkkkkkkkkkkkk.................................',
    '...................................................',
    '...................................................',
  ...
  ringCb: { palette: MAOU_T_PAL, rows: [
    '................................................',
    '................kkkkkkkkkkkkkkkk................',
    '..........kkkkkkkkkiiiiiiiiiikkkkkkkkk..........',
    '.......kkkkkiiIIIIHHHHHHHHHHHHIIIIiikkkkk.......',
    '....kkkkiIIIHIIIIIIiiiiiiiiiiIIIIIIHIIIikkkk....',
    '..kkkkiIHIIIiiikkk............kkkiiiIIIHIikkkk..',
    '.kkkiIHIIikk........................kkiIIHIikkk.',
    'kkkIHIIik..............................kiIIHIkkk',
    'kkIHIik..................................kiIHIkk',
    'kiIIIi....................................iIIIik',
    '................................................',
  ...
  ringCf: { palette: MAOU_T_PAL, rows: [
    '................................................',
    '................................................',
    '................................................',
    '................................................',
    ...
    '.......................................kiIIcHkkk',
    '........nnkk........................kkiIILHykkk.',
    '......nnnLIIiiikkk............kkkkiikILLHIkkkk..',
    '.....knkIHHyLLIIIIIikiiiiiiiiIIIILcLHkkIkkkk....',
    '.......kkkkkIIHHHHLLcLLLLLLLLyHkLWLkkkkkk.......',
    '..........kkkkkkkkkIkIIIIIIIIkkkkLkkkk..........',
    '................kkkkkkkkkkkkkkkk.k..............',
    '................................................',
  ] },
  corona: { palette: MAOU_T_PAL, rows: [
    '.....................W.....................',
    '....................YWj....................',
    '....................Yjj....................',
    '.............WW...YYYfjYY...WW.............',
  ...
  orb: { palette: MAOU_T_PAL, rows: [
    '.............nnnkkkk.............',
    '..........knnnnnnnnkkkk..........',
    '........nnnnnnkkkkknnnnnn........',
    '.......kkkkkkkkkkkkkkkkkkk.......',
    '.....kkkkkkkkkkNNNkkkkkkkkkk.....',
    '....nkkkNNNnnnNNNNNNPNPPQkkkn....',
    '....kknNNnnnnnnNNNNNNPPPPQnkk....',
    '...kkkknnnnnnkkkYkkkPnnnnnkkkk...',
    '..knkkkkkkkkYWfffffWYkkkkkkkkkk..',
    '..knNNkkkkkYfkkkkkkkfYkkkkkQqkk..',
    '..knNNnnnkYfkkkkkkkkkfYkPQQQQkk..',
    '.knNNnnnkYfkkkkkkkkkkkfYkPQQqqkk.',
    '.knNNNnnYfkkkkkkkkkkkkkfYQQrQqkk.',
    '.knNNNNkWkkkkkkkkkkkkkkkWkQrrqkk.',
    '.knNNNNkfkkkkkkkkkkkkkkkfkQqrRkk.',
    '.knNNNNkfkkkkkkkkkkkkkkkfkQQqrkk.',
    'kknNNNNYfkkkkkkkkkkkkkkkfYQqqrOkk',
    '.knNNNNkfkkkkkkkkkkkkkkkfkqQqrkk.',
    '.knPNPNkfkkkkkkkkkkkkkkkfkQqqRkk.',
    '.knNPNPkWkkkkkkkkkkkkkkkWkqqRqkk.',
    '.knPPPNPYfkkkkkkkkkkkkkfYqqqrqkk.',
    '.knPPPPPkYfkkkkkkkkkkkfYkqqqrrkk.',
    '..knPPPPPkYfkkkkkkkkkfYkqqqqqrR..',
    '..knQPnnnnkYfkkkkkkkfYknnnnqqkr..',
    '..qqqqkkkkkkYWfffffWYkkkkkkqqqq..',
    '...qqqqqqqqqqkkkYkkkqqqqqqqqqq...',
    '....kkqqqqqqqQQqQqqqqqqqqqqqk....',
    '....knnnqQqQqQqQqqqqqqrrrrrnk....',
    '.....kkknnnnnnnqqqnnnnnnnkrk.....',
    '.......kkkkkkkknnnkkkkkkkk.......',
    '........kkkkkkkkkkkkkkkkk........',
    '..........kkknkkkkkkkkk..........',
    '.............nnnkkkk.............',
  ] },
  eye: { palette: MAOU_T_PAL, rows: [
    '.....kkkkk.....',
    '...kffnnnffk...',
    '..kfnkcccknfk..',
    '.kfkccCkCCckfk.',
...
// 真の姿のリグ。眼(core)が最前面＝環は眼の後ろへ潜る＝眼がいちばん近くにいる。
const MAOU_TRUE_RIG = [
...
export const MAOU = {
  ...
  trueSprites: MAOU_TRUE_SPRITES,
  trueRig: MAOU_TRUE_RIG,
  palette3: MAOU_PAL_P,
};

// ★2026-09-13 ジャム版（unity1week）の最終ボス「堕天の大聖堂」。下半身を失って宙に浮く聖堂。
//   背後に双つの尖塔（左は折れている）と飛梁、欠けた金の歯車の光輪、羽根の無い鉄骨の翼（右は大きく、左は折れて短い）、
//   顔は無く頭部そのものが薔薇窓（12枚の硝子の中心で単眼が白熱）、胸は観音開きに割れて藍の内陣の奥で聖核が脈打ち、
//   腰からは切れた配線束が垂れて銅線を晒す。設計と作り直しの経緯は vortex/scratchpad/cathedral-candidates.mjs。
//   作法は軌道神核と同じ（大きな面＋黒い溝＋素材ごとの4段階調＋黒締め＋生きている一点）を建築の語彙で言い直したもの。
//   ⚠️ CATH_PAL_R は段階2「堕天」で硝子が全部深紅になる焼き直し用（藍 b/B/D → 深紅 r/R/A）。キー集合は CATH_PAL と一致させる。
const CATH_PAL = { k: '#04040c', q: '#161c33', Q: '#293557', P: '#45588a', N: '#8ea3d4', n: '#d2ddf6', j: '#12121c', m: '#25273a', f: '#42465e', s: '#767c9c', y: '#7a5a10', Y: '#c9971f', G: '#ffd23f', W: '#ffedb0', r: '#5c0a18', R: '#c81736', A: '#ff5a6a', b: '#0f2258', B: '#1f47b8', D: '#5f8cff', o: '#8a3a12', O: '#ff8a2a', c: '#ffffff', C: '#cfe0ff', g: '#3fd9c8', p: '#e070c0' };
const CATH_PAL_R = { k: '#04040c', q: '#161c33', Q: '#293557', P: '#45588a', N: '#8ea3d4', n: '#d2ddf6', j: '#12121c', m: '#25273a', f: '#42465e', s: '#767c9c', y: '#7a5a10', Y: '#c9971f', G: '#ffd23f', W: '#ffedb0', r: '#5c0a18', R: '#c81736', A: '#ff5a6a', b: '#5c0a18', B: '#c81736', D: '#ff5a6a', o: '#8a3a12', O: '#ff8a2a', c: '#ffffff', C: '#cfe0ff', g: '#3fd9c8', p: '#e070c0' };
const CATHEDRAL_SPRITES = {
  spires: { palette: CATH_PAL, rows: [
    '..................................................................kWk.....',
    '....................................k............................kGGGk....',
    '...................................kWk............................kGk.....',
    '...................................kGGk...........................kGk.....',
    ...
    '...................................kPPk........................knPPQQQkk..',
    '.........k........................kknkk........................knPPPQQQQk.',
    '........kqk......................knQQqqk......................knPPPPQQQQk.',
    '......kk.k......................knQQQqqqk.....................kYGYGYGYGYk.',
    '.....kQQk......................knQQQQqqqqk....................kyyyyyyyyyk.',
    '......kk......................knQQQQQqqqqqk...................knNqPbQqqqk.',
    '........k....................knkkkkkkkkkkkkkk.................knNkbDbkqqk.',
    '....k..kOk..................knQQQQQQQqqqqqqqqk.................kkkBBbkkk..',
    '...kWk..k..................knQQQQQQQQqqqqqqqqqk...............knNPbbbQqqk.',
    '...kPk.kQk................knQQQQQQQQQqqqqqqqqqqk..............knNPbbbQqqk.',
    '..kkPPkkQQk..............knQQQQQQQQQQqqqqqqqqqqqk.............knNPbbbQqqk.',
    '.kPkPPQkQQQk...........kknkkkkkkkkkkkkkkkkkkkkkkkk............knNPbbbQqqk.',
    '.kPPPPQQQQQk..........knQQQQQQQQQQQQQqqqqqqqqqqqqqk............kkkbbbkkk..',
    '.kyyyyyyyyyk.........knQQQQQQQQQQQQQQqqqqqqqqqqqqqqk..........knNqPPQqqqk.',
    '.knNqPbQqqqk........knQQQQQQQQQQQQQQQqqqqqqqqqqqqqqqkk........knNqPPQqqqk.',
    '.knNkbDbkqqk........kQQQQQQQQQQQQQQQQqqqqqqqqqqqqqqqqqk.......knNqPbQqqqk.',
    '..kkkBBbkkk..........kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk........knNkbDbkqqk.',
    '.knNPbbbQqqk...kkkk.kQQQQQQQQQQQQQQQQqqqqqqqqqqqqqqqqqkkkkk....kkkBBbkkk..',
    '.knNPbbbQqqk..kPPPPkkkQQQQQQQQQQQQQQQqqqqqqqqqqqqqqqkkkQQQQk..knNPbbbQqqk.',
    '.knNPbbbQqqk..kNNNPPPPkkQQQQQQQQQQQQQqqqqqqqqqqqqqkkQQQQPPPk..knNPbbbQqqk.',
    '.knNPbbbQqqk..kPPPNNNNPPkkQQQQQQQQQQQqqqqqqqqqqqkkQQPPPPqqqk..knNPbbbQqqk.',
    '..kkkbbbkkk...kkkkPPPNNNPPkkkkkkkkkkkkkkkkkkkkkkQQPPPqqqkkk...knNPbbbQqqk.',
    '.knNqPPQqqqk.....kkkkPPNNPPkQQQQQQQQQqqqqqqqqqkQQPPqqkkkk......kkkbbbkkk..',
    '.knNqPPQqqqk........kkkPPNNPkQQQQQQQQqqqqqqqqkQPPqqkkk........knNqPPQqqqk.',
    '.knNqPbQqqqk........kQkkkPNNPkQQQQQQQqqqqqqqkQPPqkkkqqk.......knNqPPQqqqk.',
    '.knNkbDbkqqk........kQQQkkPNNPkQQQQQQqqqqqqkQPPqkkqqqqk.......knNqPbQqqqk.',
    '..kkkBBbkkk..........kkkkkkPNPPkkkkkkkkkkkkQQPqkkkkkkk........knNkbDbkqqk.',
    '.knNPbbbQqqk........kQQQQQkkPNPkQQQQQqqqqqkQPqkkqqqqqqk........kkkBBbkkk..',
    '.knNPbbbQqqk........kQQQQQQkPPNPkQQQQqqqqkQPqqkqqqqqqqk.......knNPbbbQqqk.',
    '.knNPbbbQqqk........kQQQQQQkkPNPkQQQQqqqqkQPqkkqqqqqqqk.......knNPbbbQqqk.',
    '.knNPbbbQqqk........kQQQQQQQkkPNPkQQQqqqkQPqkkqqqqqqqqk.......knNPbbbQqqk.',
    '..kkkbbbkkk..........kkkkkkkkkPNPkkkkkkkkQPqkkkkkkkkkk........knNPbbbQqqk.',
    '.knNqPPQqqqk........kQQQQQQQQkPNPkQQQqqqkQPqkqqqqqqqqqk........kkkbbbkkk..',
    '.knNqPPQqqqk........kQQQQQQQQkkPNPkQQqqkQPqkkqqqqqqqqqk.......knNqPPQqqqk.',
    '.knNqPPQqqqk........kQQQQQQQQQkPNPQQQqqkQPqkqqqqqqqqqqk.......knNqPPQqqqk.',
    '.knNqPPQqqqk........kQQQQQQQQQQQQQQQQqqqqqqqqqqqqqqqqqk.......knNqPPQqqqk.',
    '..kkkkkkkkk..........kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk........knNqPPQqqqk.',
    '.knNPPqQQqqk........kQQQQQQQQQQQQQQQQqqqqqqqqqqqqqqqqqk........kkkkkkkkk..',
    '.knNPPqQQqqk........kQQQQQQQQQQQQQQQQqqqqqqqqqqqqqqqqqk.......knNPPqQQqqk.',
  ] },
  halo: { palette: CATH_PAL, rows: [
    '....kkkkkkkykYYYYYYYYYYYYkkykkkk......',
    '...kyYYYYYYYYYYYYYYYYYYYYYYYYYYYk...k.',
    'kkkYYYYYGGYYyyykkkkkkkkyyyYYGGYWYk.kWk',
    'yYYYYGYykkkkkkk........kkkkkkkykk...k.',
    'YYYGykkk......................k.......',
    'YYGyk............................kk...',
    'YYYGykkk......................kkkyYkk.',
    'kYYYYGYykkkkkkk........kkkkkkkyYGYcWYk',
    'kykYYYWWWWWWyyykkkkkkkkyyyWWWWWWYYYyk.',
    '.k.kkkyYYYYWWWWWWWWWWWWWWWWYYYYYkkkk..',
    '......kkkkkkkYyYYYYYYYYYYkkkkkyk......',
  ] },
  rose: { palette: CATH_PAL, rows: [
    '........kNNNk........',
    '.....kNNNNkNNNNk.....',
    '....NNNkGGGGGkNNk....',
    '...NNQGWYkkkYWYQQk...',
    ...
    '.NNGkDckkDkDkkcBkYQk.',
    '.NkWkkkAkkkkkBkkkWkQ.',
    'kNGYDDkkYkkkYkkBBYkQk',
    'kQYkAcAkkCkckkRcRkYQk',
    'kkYkkkkkkcOckkkkkkYkk',
    'kQYkAcAkkckckkRcrkYQk',
    'kQkYDDkkYkkkYkkbbYkQk',
    '.QkWkkkBkkkkkrkkkWkQ.',
    '.kQYkBckkBkbkkcbkYQk.',
    '.kkQYkRkRckcrkrkYQkk.',
    '..kQkYYkrbkbrkkYkQk..',
  ...
  nave: { palette: CATH_PAL, rows: [
    '.kkkkkkkkkkkkkkkkkkkkkkkkkk.',
    'kGGYGGYGGYGGYGGYGGYGGYGGYGGk',
    'kyyyyyyyyyyyyyyyyyyyyyyyyyyk',
    '.kkkkkkkkkkkkkkkkkkkkkkkkkk.',
    'knnqNNNNPqPkbbbqkPPPQqQQQqqk',
    'knnqNNNPPqkbbbbbbkPQQqQQQqqk',
    '.kkkjmfskbbbBBBbbbkksfmjkkk.',
    'knnNjYfskbbBBBBBBbbksfYjqqqk',
    'knnNjmfGkbbBBDDBBbbkGfmjqqqk',
    '.kkkjmfskbBBDDDDBBbksfmjkkk.',
    'knnqjYfskbBBDDDDBBbksfYjQqqk',
    'knnqjmfskbBBDDDDBBbksfmjQqqk',
    '.kkkjmfGkbbBBDDBBbbkGfmjkkk.',
    'knnPjYfskbbBDDDDDbbksfYjqqqk',
    'knnkjmkskbbCCCCCCCbkskmjkqqk',
    '.kk.kmkkkbbbbbbbbbbkskkjkkk.',
    '.....k...kkkkkkkkkk.k..k....',
  ] },
  relic: { palette: CATH_PAL, rows: [
    'G....kk....G',
    '..kkYYYYkk..',
    '.kYWcRRcWYk.',
    'kYWcAORRcWYk',
  ...
  wingR: { palette: CATH_PAL, rows: [
    '......................................',
    '..........................kkkk........',
    '.....................kkkkkjjjjk.......',
    '...............kkkkkkjjjffsssYk.......',
    '...........k.kkjjjjffssssssfjjk.......',
    '..........kjkWkfsssssYfjjjjkkk........',
    '..........kkYYYksjjjgsmffffk..........',
    '.........kjfkYkssssffjjjffffk.........',
    '........kjjfsksssffssssffjjjskkk......',
    '........kjfsfjssssfjjjfssYsffjjjkkk...',
    '.......kjfssfjjsjssfjmmjjjsssssffjjkk.',
    '.......kjfsfjjjssjjssjsmfffjjjsssssfjk',
    '......kjfssjjjjjsjmjssjjkkkffffjpjssYk',
    '......kjfsfjjjjjsfjmjssfjkkkfskkkkjjjk',
    '.....kjfsfjjjjjjssjmkjssfjkkfk....kkk.',
    '....kjfsYfjjjjmjjsfmmkjfYsjkfk........',
    '....kjfsfjmmmmmmmssjmkkjjssfjfk.......',
    '...kjfsfjmmmmmmmmjsfmsfffjssfjfk......',
    '..kjjssfjmmmmmmmmjssjfffffjssfjk......',
    '..kjfsfjmmmmmmmmmmjYfffffffjfssjkk....',
    '.kjfssfjmmmmmmmmmmjssjffffsfjjssjjk...',
    '.kkfsfjmmmmmmsmmmmmjsjffskkkffjssfjk..',
    'kYYYkjjmmmmsmmmmmmkjssjffk..kkkjssfjk.',
    'YWYYYjmmmsmmmmmmmmkkjsjffk.....kjsYk..',
    'YYyYYkkkkkkmmmmmmmkkjssjfk......kjk...',
    'YYYYYk.....kkkkmsmk.kjsjfk.......k....',
    'kYYYk..........kkfk.kjsfjk............',
    '.kkk.............k.k.kssjk............',
    '.....................kjsfk............',
    '.....................kfssjk...........',
  ...
  wingL: { palette: CATH_PAL, rows: [
    ...
    '.......kjfkYksssfjjfffk.....',
    '......kjjfskssjsssffjjfk....',
    '......kjfsfjjsfjjfsYsfjjkkk.',
    '.....kjfssjjjssjkkjjfsssfjjk',
    '....kjjfsfjjjjssjkkkkjjsssff',
    '....kjfsfjjjjmjsfjkkkffjjfsY',
    '...kjfsYfjmmmmmssfkfffkkkkjj',
    '...kjfsfjmmmmmmjsYWfsk....kk',
    '..kjfsfjjmmmmmmmjssjk.......',
    '.kjjssfjmmmmmmmmsfsOk.......',
    '.kkfsfjmmmmmmmsmmjssk.......',
    'kYYYkjjmmkkkkkmmmfjsk.......',
    'YWYYYjkkk.....kkkfffk.......',
    'YYyYYk...........kkjk.......',
    'YYYYYk.............k........',
    'kYYYk.......................',
  ...
  cables: { palette: CATH_PAL, rows: [
    '...kffffffffffffffffffk...',
    '...kmfjmmfmmkfjkmfkmfjk...',
    '...ksmkkkkskksmkkskkksmk..',
    '..kfjk...kfkfjk.kfk..kfjk.',
    '.kfjk.....kffjk.kfk...kfjk',
    'kfjk.....kfkfjkkfk.....kfj',
    'ksmk.....kskksmoOk.....ksm',
    'fjk.....koOkkfjkkok.....kf',
...
// 座標は本体中心からのドット単位。mirror の翼は origin 中央＋ox で置く（端 origin は mirror で反転して胴の裏へ潜る）。
const CATHEDRAL_RIG = [
  { role: 'thruster', tex: 'spires', ox: 0, oy: -9 },
  { role: 'wingR', tex: 'wingR', ox: 30, oy: -14 },
  { role: 'wingL', tex: 'wingL', ox: -25, oy: -13, mirror: true },
  { role: 'legL', tex: 'cables', ox: 0, oy: 9, origin: [0.5, 0.05] },
  { role: 'body', tex: 'nave', ox: 0, oy: 2 },
  { role: 'dome', tex: 'halo', ox: 0, oy: -25 },
...
export const CATHEDRAL = {
  ...
  name: '堕天の大聖堂',
  color: '#c9971f',
  sprites: CATHEDRAL_SPRITES,
  rig: CATHEDRAL_RIG,
  palette2: CATH_PAL_R,   // 段階2「堕天」の深紅の硝子（boss.js が boss_cathedral_R<tex> として焼く）
};

// 出現順（小→final）。Boot/validate はこの配列を走査してテクスチャ生成・検証する。
export const BOSSES = [KOROTAMA, JETVIPER, UZUKING, WAVELORD, MISSILGA, MAOU];
// ★2026-09-13 ジャム版の最終ボスを含む全定義（テクスチャ生成用）。BOSSES は本編の6体のまま＝並び・検証に影響させない。
export const BOSS_DEFS_ALL = [...BOSSES, CATHEDRAL];
