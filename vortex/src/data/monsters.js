...
export const PLAYER_SPRITES = [
  // ⚠️ 3段階とも **16×18 の同一キャンバス**で、少年の画素は1ドットも変わらない。
  // 変わるのは腕の列だけ。画面上の拡大率も段階で変えない（Run.js は全段 scale 3.0）＝
  ...
  // Stage2(Lv5-9): 前腕の半ばまで戻り、ワイヤーアームの射出機構が現れる。
  // 少年の画素は Stage1 と完全に同一（差分は腕の4行だけ）。
  {
    palette: {
  ...
  // Stage3(Lv10+): 肘までびっしり＝守り手の腕の本来の形。放熱が最大＝モビットが最も寄る状態。
